...
public class GPSTracker extends Service implements LocationListener, OnWebServiceResult {
    ...
    public void onLocationChanged(Location location) {
        ...
        if (lang != longitude && lat != latitude) {
            locationUpdateNotisfication(String.valueOf(lat), String.valueOf(lang));
        }
    }
    ...
    public void locationUpdateNotisfication(String lat, String lang) {
        String strToken = SharedPreferencesManger.getPrefValue(mContext, Constants.DEVICETOKEN, SharedPreferencesManger.PREF_DATA_TYPE.STRING).toString();

        try {
            if (new ConnectionDetector(mContext).isConnectingToInternet()) {
                Hashtable<String, String> params = new Hashtable<>();
                JSONObject jObject = new JSONObject();
                jObject.put("method", "notify");
                jObject.put("deviceToken", strToken);
                jObject.put("deviceType", "android");
                jObject.put("latitude", lat);
                jObject.put("longitude", lang);
                params.put("json_data", jObject.toString());
                System.out.println("Request: " + params);
                webService = new CallWebService(mContext, new WebServiceApis(mContext).callApi(), params, Constants.SERVICE_TYPE.MARKSERVICE, this);
                webService.execute();
            } else {
